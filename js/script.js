...
console.log(Person.prototype.sayMyName === jim.sayMyName) 
console.log(jim.sayMyName() === 'james')
console.log(jim.age === 0)  
jim.ageAYear()
console.log(jim.age === 1)  
...
console.assert(Person.prototype.sayMyName === jim.sayMyName)  //false?
console.assert(jim.sayMyName() === 'james') //true
console.assert(jim.age === 0) //true
jim.ageAYear()
console.assert(jim.age === 1) //false ?
